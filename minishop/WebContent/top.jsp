...
<title>Insert title here</title>
   <link rel="stylesheet"
    href="/minishop/common/css/lavalamp_test.css" type="text/css" media="screen">
    <script type="text/javascript" 
    		src="/minishop/common/js/jquery-1.2.3.min.js"></script>
    <script type="text/javascript"
     src="/minishop/common/js/jquery.easing.min.js"></script>
    <script type="text/javascript"
     src="/minishop/common/js/jquery.lavalamp.min.js"></script>
	...
	<a href="#">회원가입</a></h5>
		...
		<div>
			<ul class="lavaLampNoImage" id="menu">
				...
				<li>
				<a href="/minishop/prdlist.do?category=CAT000000001&pathurl=../product/prdlist.jsp">DRESS</a></li>
